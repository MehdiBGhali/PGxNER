...
def parse_parameters(parser=None):
    ...
    ## Required
    parser.add_argument("--input_filepath", default="/data/dai031/Experiments/PGxCorpus/text-inline", type=str)
    parser.add_argument("--output_dir", default="/data/dai031/Experiments/PGxCorpus/split", type=str)
